import svgPaths from "./svg-lw2ofsud0v";
...
import { imgGroup } from "./svg-apt0g";
type BackgroundImage338Props = {
  additionalClassNames?: string[];
};

function BackgroundImage338({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage338Props>) {
  return (
...
function BackgroundImage81({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage338 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function TabItem() {
  return (
    <BackgroundImage126 additionalClassNames={["rounded", "shrink-0"]}>
...
function ProductCard() {
  return (
    <BackgroundImage338 additionalClassNames={["rounded-xl"]}>
...
function Wallet3() {
  return (
    <BackgroundImage338 additionalClassNames={["h-12", "rounded-lg"]}>
      <BackgroundImage66>
        <div className="css-w9luqw font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#000000] text-[14px] text-left text-nowrap">
...
function Tooltip() {
  return (
    <div
      className="absolute bg-[#ffffff] left-[183px] rounded-md shadow-[0px_2px_4px_0px_rgba(30,41,59,0.25)] top-[586px]"
      data-name="tooltip"
    >
      <div className="flex flex-row items-center relative size-full">
