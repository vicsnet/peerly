import svgPaths from "./svg-woc6yv4a3i";
...
import { imgGroup } from "./svg-ngwf3";
...
type BackgroundImage60Props = {
  additionalClassNames?: string[];
};

function BackgroundImage60({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage60Props>) {
  return (
...
function PeerlyFullLogo() {
  return (
    <BackgroundImage60 additionalClassNames={["shrink-0"]}>
      <PeerlyLogo />
...
function Field() {
  return (
    <BackgroundImage137 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function IconShoppingCart1() {
  return (
    <BackgroundImage75>
      <g clipPath="url(#clip0_117_601)" id="icon/shopping-cart">
        <path
...
function Button1() {
  return (
    <BackgroundImage90 additionalClassNames={["rounded-[96px]"]}>
...
function Button3() {
  return (
    <BackgroundImage90 additionalClassNames={["bg-slate-900", "rounded-md"]}>
      <BackgroundImageAndText1 text="Start Selling" />
    </BackgroundImage90>
  );
}
    ...
    >
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col h-[248px] items-start justify-between p-[40px] relative w-full">
          <Text />
          <BackgroundImage44 text="Start Selling" />
        </div>
      </div>
    </BackgroundImage137>
  );
...
function Actions() {
  return (
    <BackgroundImage137 additionalClassNames={["bg-[#ffffff]"]}>
      <div className="absolute border-[1px_0px_0px] border-slate-100 border-solid inset-0 pointer-events-none" />
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-3 items-start justify-start pb-6 pt-3 px-6 relative w-full">
          <Button5 />
          <Button6 />
        </div>
      </div>
