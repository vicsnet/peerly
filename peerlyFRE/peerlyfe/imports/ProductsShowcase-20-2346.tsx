import svgPaths from "./svg-ga1fyacwcf";
...
import { imgGroup } from "./svg-l6hnz";
import Image from "next/image";
type BackgroundImage331Props = {
  additionalClassNames?: string[];
};

function BackgroundImage331({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage331Props>) {
  return (
...
function BackgroundImage202({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage156({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage81({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage331 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function TextBackgroundImage({ text, text1 }: TextBackgroundImageProps) {
  return (
    <BackgroundImage126 additionalClassNames={["shrink-0", "w-full"]}>
...
function TextBackgroundImageAndText({
  text,
  additionalClassNames = [],
}: TextBackgroundImageAndTextProps) {
...
function PeerlyFullLogo() {
  return (
    <BackgroundImage141 additionalClassNames={["shrink-0"]}>
      <PeerlyLogo />
...
function TabItem1() {
  return (
    <BackgroundImage126 additionalClassNames={["rounded-[3px]", "shrink-0"]}>
      <BackgroundImageAndText
        text="Specification"
        additionalClassNames={["py-1"]}
      />
    </BackgroundImage126>
  );
}
    ...
    >
      <div className="box-border content-stretch flex flex-col gap-3 h-96 items-start justify-start overflow-clip p-0 relative w-full">
        ...
        >
          ...
          />
          <TextBackgroundImageAndText text="The shoe upper is the most popular style this year, it is both cool and versatile. The upper texture is comfortable, soft, casual, and elegant. The internal design has vents, allowing you to breathe freely and comfortably, so you..." />
        </div>
        <NavigationMenuItem />
      </div>
    </div>
...
function ProductCard() {
  return (
    <BackgroundImage331 additionalClassNames={["rounded-xl"]}>
...
function Wallet3() {
  return (
    <BackgroundImage331 additionalClassNames={["h-12", "rounded-lg"]}>
      <BackgroundImage66>
        <div className="css-w9luqw font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#000000] text-[14px] text-left text-nowrap">
...
export default function ProductsShowcase() {
  return (
    <BackgroundImage126 additionalClassNames={["bg-slate-50", "size-full"]}>
