import svgPaths from "./svg-aa548w4m1g";
...
function BackgroundImage75({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage75Props>) {
  return (
...
function BackgroundImage45({ children }: React.PropsWithChildren<{}>) {
  return (
...
function PeerlyFullLogo() {
  return (
    <BackgroundImage30 additionalClassNames={["shrink-0"]}>
      <PeerlyLogo />
...
function Field() {
  return (
    <BackgroundImage75 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function IconShoppingCart1() {
  return (
    <BackgroundImage45>
      <g clipPath="url(#clip0_104_1495)" id="icon/shopping-cart">
        <path
