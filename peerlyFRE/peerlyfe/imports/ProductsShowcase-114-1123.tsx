import svgPaths from "./svg-z5cvil9afb";
...
import { imgGroup } from "./svg-2g59l";
type BackgroundImage316Props = {
  additionalClassNames?: string[];
};

function BackgroundImage316({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage316Props>) {
  return (
...
function BackgroundImage81({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage316 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function IconShoppingCart1() {
  return (
    <BackgroundImage171>
      <g clipPath="url(#clip0_114_1165)" id="icon/shopping-cart">
        <path
...
function ProductCard() {
  return (
    <BackgroundImage316 additionalClassNames={["rounded-xl"]}>
...
function Text5() {
  return (
    <TextBackgroundImage2>
      <HeaderBackgroundImage text="Color" />
      <Row1 />
    </TextBackgroundImage2>
  );
}
...
function IconHelpCircle() {
  return (
    <BackgroundImage233>
      <g clipPath="url(#clip0_114_1152)" id="icon/help-circle">
        <path
...
function Wallet3() {
  return (
    <BackgroundImage316 additionalClassNames={["h-12", "rounded-lg"]}>
      <BackgroundImage66>
        <div className="css-w9luqw font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#000000] text-[14px] text-left text-nowrap">
...
function Text7() {
  return (
    <TextBackgroundImage2>
      <HeaderBackgroundImage text="Payment Methods" />
      <Wallets />
      <Wallet3 />
    </TextBackgroundImage2>
  );
...
function SectionItems() {
  return (
    <BackgroundImage316 additionalClassNames={["h-0"]}>
...
function Product1() {
  return (
    <BackgroundImage316 additionalClassNames={["bg-slate-50", "rounded"]}>
