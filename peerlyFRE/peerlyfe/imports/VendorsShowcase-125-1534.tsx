import svgPaths from "./svg-cx57kadif9";
...
import { imgGroup } from "./svg-8t6m4";
...
function BackgroundImage14({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage89 additionalClassNames={["bg-[#ffffff]"]}>
...
function TextBackgroundImage({ text, text1 }: TextBackgroundImageProps) {
  return (
    <BackgroundImage29 additionalClassNames={["shrink-0", "w-full"]}>
...
function Field() {
  return (
    <BackgroundImage89 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function IconShoppingCart1() {
  return (
    <BackgroundImage59>
      <g clipPath="url(#clip0_125_1561)" id="icon/shopping-cart">
        <path
...
function MenuItem4() {
  return (
    <BackgroundImage14>
      <div className="basis-0 css-9u39cd font-['Inter:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[14px] text-left text-red-700">
        <p className="block leading-[20px]">Sign out</p>
      </div>
    </BackgroundImage14>
  );
}
  ...
  return (
    ...
    >
      <div className="box-border content-stretch flex flex-col items-start justify-start pb-[5px] pt-0 px-[5px] relative w-full">
        <MenuitemBackgroundImageAndText text="Profile" />
        <MenuitemBackgroundImageAndText text="Orders" />
        <MenuitemBackgroundImageAndText text="Transactions" />
        <MenuItem4 />
      </div>
    </BackgroundImage29>
  );
...
function SelectOptions() {
  return (
    <div
      className="absolute left-[1220px] rounded-md top-[142px] w-[140px]"
      data-name="select options"
    >
      <div className="box-border content-stretch flex flex-row items-start justify-start overflow-clip p-0 relative w-[140px]">
        <Frame11 />
      </div>
...
export default function VendorsShowcase() {
  return (
    <BackgroundImage29 additionalClassNames={["bg-slate-50", "size-full"]}>
