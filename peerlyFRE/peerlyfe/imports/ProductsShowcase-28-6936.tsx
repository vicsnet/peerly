import svgPaths from "./svg-1pp69peawh";
...
import { imgGroup } from "./svg-qy7en";
type BackgroundImage348Props = {
  additionalClassNames?: string[];
};

function BackgroundImage348({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage348Props>) {
  return (
...
function BackgroundImage266({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage348>
...
function BackgroundImage233({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage217({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage201({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage348>
...
function BackgroundImage186({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage171({ children }: React.PropsWithChildren<{}>) {
  return (
...
type BackgroundImage156Props = {
  additionalClassNames?: string[];
};

function BackgroundImage156({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage156Props>) {
  return (
...
type BackgroundImage141Props = {
  additionalClassNames?: string[];
};

function BackgroundImage141({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage141Props>) {
  return (
    <div className={clsx("relative", additionalClassNames)}>
...
type BackgroundImage126Props = {
  additionalClassNames?: string[];
};

function BackgroundImage126({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage126Props>) {
  return (
...
type BackgroundImage111Props = {
  additionalClassNames?: string[];
};

function BackgroundImage111({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage111Props>) {
  return (
...
function BackgroundImage81({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage348 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function WalletBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="basis-0 grow h-12 min-h-px min-w-px relative rounded-lg shrink-0">
      ...
      <BackgroundImage66>{children}</BackgroundImage66>
    </div>
  );
}
...
function TextBackgroundImage({ text, text1 }: TextBackgroundImageProps) {
  return (
    <BackgroundImage141 additionalClassNames={["shrink-0", "w-full"]}>
...
function PeerlyFullLogo() {
  return (
    <BackgroundImage156 additionalClassNames={["shrink-0"]}>
      <PeerlyLogo />
...
function IconShoppingCart() {
  return (
    <BackgroundImage171>
      <g clipPath="url(#clip0_28_6980)" id="icon/shopping-cart">
        <path
...
function Button() {
  return (
    <BackgroundImage126 additionalClassNames={["rounded-[96px]"]}>
...
function TabItem() {
  return (
    <BackgroundImage141 additionalClassNames={["rounded", "shrink-0"]}>
...
function TabItem2() {
  return (
    <BackgroundImage141 additionalClassNames={["rounded-[3px]", "shrink-0"]}>
...
function ProductCard() {
  return (
    <BackgroundImage348 additionalClassNames={["rounded-xl"]}>
...
function Button5() {
  return (
    <BackgroundImage96 additionalClassNames={["size-8"]}>
...
function IconHelpCircle() {
  return (
    <BackgroundImage233>
      <g clipPath="url(#clip0_28_6949)" id="icon/help-circle">
        <path
...
function Wallet3() {
  return (
    <BackgroundImage348 additionalClassNames={["h-12", "rounded-lg"]}>
      <BackgroundImage66>
        <div className="css-w9luqw font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#000000] text-[14px] text-left text-nowrap">
...
function Button11() {
  return (
    <BackgroundImage96 additionalClassNames={["w-full"]}>
      <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-4 py-2 relative w-full">
        <div className="css-98cyo3 font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[14px] text-left text-nowrap text-slate-900">
    ...
    >
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-4 items-center justify-start px-6 py-4 relative w-[540px]">
          <BackgroundImageAndText3 text="Checkout" />
        </div>
      </div>
    </div>
  );
    ...
    <BackgroundImage348>
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-between px-6 py-4 relative w-full">
          <BackgroundImageAndText3 text="Order summary" />
          <IconX />
        </div>
      </div>
    </BackgroundImage348>
...
function SectionItems() {
  return (
    <BackgroundImage348 additionalClassNames={["h-0"]}>
...
function IconInfo() {
  return (
    <BackgroundImage233>
      <g clipPath="url(#clip0_28_6940)" id="icon/info">
        <path
          d={svgPaths.p3e7757b0}
          id="Vector"
...
function Product1() {
  return (
    <BackgroundImage348 additionalClassNames={["bg-slate-50", "rounded"]}>
...
export default function ProductsShowcase() {
  return (
    <BackgroundImage141 additionalClassNames={["bg-slate-50", "size-full"]}>
