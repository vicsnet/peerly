import svgPaths from "./svg-z0do6k7ref";
...
import { imgGroup } from "./svg-axr3f";
...
function IconShoppingCart() {
  return (
    <BackgroundImage171>
      <g clipPath="url(#clip0_30_9187)" id="icon/shopping-cart">
        <path
...
function IconHelpCircle() {
  return (
    <BackgroundImage233>
      <g clipPath="url(#clip0_30_9196)" id="icon/help-circle">
        <path
