import svgPaths from "./svg-a3dtmxlznw";
...
import { imgGroup } from "./svg-edhqj";
import Image from "next/image";
type BackgroundImage261Props = {
  additionalClassNames?: string[];
};

function BackgroundImage261({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage261Props>) {
  return (
...
function BackgroundImage143({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage261>
...
function BackgroundImage113({ children }: React.PropsWithChildren<{}>) {
  return (
...
type BackgroundImage98Props = {
  additionalClassNames?: string[];
};

function BackgroundImage98({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage98Props>) {
  return (
...
type BackgroundImage83Props = {
  additionalClassNames?: string[];
};

function BackgroundImage83({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage83Props>) {
  return (
    <div className={clsx("relative", additionalClassNames)}>
...
type BackgroundImage68Props = {
  additionalClassNames?: string[];
};

function BackgroundImage68({
  children,
  additionalClassNames = [],
}: React.PropsWithChildren<BackgroundImage68Props>) {
  return (
    <div
      className={clsx(
...
function BackgroundImage53({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage261 additionalClassNames={["bg-[#ffffff]", "rounded-md"]}>
...
function TextBackgroundImage({ text, text1 }: TextBackgroundImageProps) {
  return (
    <BackgroundImage83 additionalClassNames={["shrink-0", "w-full"]}>
...
function PeerlyFullLogo() {
  return (
    <BackgroundImage98 additionalClassNames={["shrink-0"]}>
      <PeerlyLogo />
...
function IconShoppingCart1() {
  return (
    <BackgroundImage113>
      <g clipPath="url(#clip0_106_1086)" id="icon/shopping-cart">
        <path
...
function TabItem() {
  return (
    <BackgroundImage83 additionalClassNames={["rounded", "shrink-0"]}>
...
function TabItem2() {
  return (
    <BackgroundImage83 additionalClassNames={["rounded-[3px]", "shrink-0"]}>
...
function ProductCard() {
  return (
    <BackgroundImage261 additionalClassNames={["rounded-xl"]}>
...
function Button6() {
  return (
    <BackgroundImage68 additionalClassNames={["size-8"]}>
...
function IconHelpCircle() {
  return (
    <BackgroundImage191>
      <g clipPath="url(#clip0_106_1066)" id="icon/help-circle">
        <path
...
function Button9() {
  return (
    <BackgroundImage68 additionalClassNames={["w-full"]}>
      <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-4 py-2 relative w-full">
        <div className="css-98cyo3 font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[14px] text-left text-nowrap text-slate-900">
...
export default function ProductsShowcase() {
  return (
    <BackgroundImage83 additionalClassNames={["bg-slate-50", "size-full"]}>
