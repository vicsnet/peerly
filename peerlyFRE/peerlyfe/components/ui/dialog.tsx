...
import { useDialogDescription } from "../../contexts/DialogContext";
...
>(({ className, children, description = "Dialog content", ...props }, ref) => {
  ...
  const fullDescriptionId = `dialog-desc-${descriptionId}`;
  
  // Check if there's already a DialogDescription among the children
