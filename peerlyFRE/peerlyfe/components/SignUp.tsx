...
export function SignUp({ onSignUp, onSignIn, onClose, isSellerFlow = false }: SignUpProps) {
  return (
      ...
      <div className="flex flex-col gap-6 p-4 sm:p-6 md:p-[40px] max-w-[1440px] mx-auto">
        ...
        <div className="bg-white h-24 rounded-[20px] w-full shadow-sm border border-slate-50">
          <div className="h-full flex items-center justify-between px-10 md:px-12">
            ...
            {/* Right side with sign in link and close button */}
        ...
        <div className="flex flex-col items-center justify-center mt-12">
          ...
          <div className="w-[540px] flex flex-col items-center text-center mb-6">
            <h1 className="text-[30px] font-semibold text-gray-900 tracking-[-0.225px] mb-1">
              {isSellerFlow ? "Create a seller account" : "Create an account"}
            </h1>
            <p className="text-[14px] text-gray-900">
              {isSellerFlow 
                ? "Get started in seconds to begin selling your products on Peerly" 
                : "Get started in seconds. Register using your email, or sign in with Google or Apple"}
            </p>
          </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <button 
                    ...
                    onClick={onSignUp}
                  >
                    {isSellerFlow ? "Create Seller Account" : "Create Account"}
                  </button>
                  
                  <div className="flex items-center gap-2 mt-1">
                    <div className="size-3.5 rounded-sm border border-gray-200"></div>
                    <p className="text-[10px] text-gray-500">
                      <span>By selecting Create an account, you agree to our </span>
                      <span className="underline font-semibold text-gray-900">User Agreement</span>
                      <span> and acknowledge reading our </span>
                      <span className="underline font-semibold text-gray-900">User Privacy Notice</span>
