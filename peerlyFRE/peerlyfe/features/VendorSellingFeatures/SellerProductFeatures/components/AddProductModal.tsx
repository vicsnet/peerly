...
export function AddProductModal({ isOpen, onClose, vendorId, onAddProduct }: AddProductModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        ...
        description="Add a new product to your store with details, images, and specifications."
      >
