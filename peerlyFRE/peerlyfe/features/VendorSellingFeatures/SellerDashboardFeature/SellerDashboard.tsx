...
// export function SellerDashboard({ businessName, initialPage = "home" }: SellerDashboardProps) {
...
//     ? getProductsByVendor(vendorId).find(p => p.id === selectedProductId)
//     : null;
...
//           {/* Products */}
//           <button
//             className={`flex items-center gap-2 px-2 py-1.5 rounded-md ${currentPage === 'products' || currentPage === 'product-details' ? 'bg-slate-100' : 'bg-white'
//               }`}
...
//                     <h3 className="text-[18px] font-semibold">{getProductsByVendor(vendorId).length}</h3>
//                   </div>

//                   {/* Total Orders */}
//                   <div className="bg-white border border-slate-100 rounded-xl p-6">
//                     <p className="text-[14px] text-gray-900">Total Orders</p>
//                     <h3 className="text-[18px] font-semibold">64</h3>
//                   </div>

//                   {/* Total Revenue */}
//                   <div className="bg-white border border-slate-100 rounded-xl p-6">
//                     <p className="text-[14px] text-gray-900">Total Revenue</p>
//                     <h3 className="text-[18px] font-semibold">$ 12,450</h3>
//                   </div>
